...
class TestCreate:
    ...
    def setUp(self):
        ...
        self.api_client.force_authenticate(user=User.objects.get(username='username'))
    ...
    def test_inventory_create(self, user_id, item_id, expected, setUp):
    ...
    def test_offer_create(self, quantity, expected, setUp):
